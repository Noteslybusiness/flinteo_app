...
import ExploreScreen from "../views/admin/explore/screens/ExploreScreen";
...
import DiscoverScreen from "../views/viewer/discover/screens/DiscoverScreen";
import ViewerInboxScreen from "../views/viewer/inbox/screens/ViewerInboxScreen";
...
const AdminUserNavigator: React.FC = () => (
    <AppScreenStack.Navigator initialRouteName={AppScreens.ADMIN_USER_TAB_STACK}>
        ...
        <AppScreenStack.Screen options={{ headerShown: false }} name={AppScreens.CONTENT_STACK} component={ContentNavigator} />
...
const AdminUserTabNavigator: React.FC = () => (
    ...
    >
        ...
        <AppScreenStack.Screen options={{ headerShown: false }} name="Explore" component={ExploreScreen} />
...
const ContentNavigator:React.FC = () => (
    <AppScreenStack.Navigator initialRouteName={AppScreens.MY_PUBLISHED_CONTENT_SCREEN}>
        <AppScreenStack.Screen options={{ headerShown: false }} name={AppScreens.MY_PUBLISHED_CONTENT_SCREEN} component={MyContentsScreen} />
...
const ViewerUserTabNavigator: React.FC = () => (
    ...
    >
        ...
        <AppScreenStack.Screen options={{ headerShown: false }} name="Discover" component={DiscoverScreen} />
        <AppScreenStack.Screen options={{ headerShown: false }} name="Inbox" component={ViewerInboxScreen} />
