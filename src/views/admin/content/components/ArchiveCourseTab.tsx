...
const ArchiveCourseTab: React.FC = () => {
    ...
    const renderItem = ({ item }: any) => (
        ...
        >
            ...
            <View style={styles.infoContainer}>
                ...
                <Text
                    numberOfLines={2}
                    style={[styles.description, { color: colors.surfaceText }]}
                >
                ...
                <View style={styles.metaRow}>
                    <View style={styles.metaItem}>
                        ...
                        <Text
                            style={[styles.metaText, { color: colors.surfaceText }]}
                        >
...
export default ArchiveCourseTab;
